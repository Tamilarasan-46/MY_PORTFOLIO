...
import { sendEmail, emailDeliversDirectly } from "../lib/contact";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-fg-subtle">
            Open to software developer roles and freelance work in ERP,
            accounting platforms and Vue.js product engineering.
          </p>
        </header>
            ...
            <div className="surface-card p-6 lg:p-8 h-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label
                    htmlFor="name"
                    className="block text-sm font-medium text-fg-subtle mb-2"
                  >
                    Your name
                  </label>
                  <input
                  ...
                  {status === "handoff" && (
                    <p className="flex items-start gap-2 text-sm text-fg-subtle">
                      <CheckCircle2
                        ...
                        aria-hidden="true"
                      />
                      Your email client should be open with the message ready.
                      If nothing happened, write to {profile.email} or use
                      WhatsApp.
                    </p>
                  )}
                  {status === "error" && (
